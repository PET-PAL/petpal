...
public class AdminUserInfoDTO { 
	...
	public AdminUserInfoDTO(int code, String id, String phone, String name, String nikname, String pwd, String email,
	...
	public String toString() {
		return "AdminUserInfoDTO [code=" + code + ", id=" + id + ", phone=" + phone + ", name=" + name + ", nikname="
