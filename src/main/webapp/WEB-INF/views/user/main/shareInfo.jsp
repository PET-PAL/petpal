...
<jsp:include page="../common/userHeader.jsp"/>
	 ...
	 <section id="product" class="product">
		...
		<div class="container">	
			<div class="row">
		 			...
		 			<p role="presentation" style="font-weight:800; font-size:25px; color:#19A985; margin-top:10px; float:left; margin-right:15px;"> 일반 정보 공유</p>
							 <button type="button" class="send_btn" onclick="location.href='#completeReport'"><strong>게시글 작성신청</strong></button>
                
							 </div>	
						 	<form class="d-flex" style="float:right;">
							     <div class="search">
							      <input type="text" placeholder="키워드로 검색해주세요.">
                       ...
                       <div class="item active" style="margin-top:20px;">
                            <div class="col-sm-3">
                                <div class="port_item xs-m-top-30">
                                    ...
                                    <div class="port_caption m-top-20" align="center" style="margin-bottom:20px;">
                                        <h4><strong>당신의 집에 고양이가 없는 이유</strong></h4>
                            ...
                            <div class="col-sm-3">
                                <div class="port_item xs-m-top-30">
                                    ...
                                    <div class="port_caption m-top-20" align="center" style="margin-bottom:20px;">
                                        <h4><strong>고양이 설사, 원인과 대처법</strong></h4>
                                        <h5>업나라</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="port_item xs-m-top-30">
                                    ...
                                    <div class="port_caption m-top-20" align="center" style="margin-bottom:20px;">
                                        <h4><strong>새끼 고양이 입양시 8가지 팁</strong></h4>
                                        <h5>손손손</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="port_item xs-m-top-30">
                                    ...
                                    <div class="port_caption m-top-20" align="center" style="margin-bottom:20px;">
                                        <h4><strong>강아지에게 주면 안되는 간식</strong></h4>
                                        <h5>킘해해</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="port_item xs-m-top-30">
                                    ...
                                    <div class="port_caption m-top-20" align="center" style="margin-bottom:20px;">
                                        <h4><strong>강아지 식사량 조절에 관한 글</strong></h4>
                                        <h5>뉴쥔</h5>
                                    </div>
                                </div>
                            </div>
   ...
   <div id="completeReport" class="overlay">
    ...
    width: 120px; margin: 0px auto; margin-left: 220px; margin-bottom: -70px;">
    				<i class="far fa-times-circle fa-4x" style="float:right; color:#45B99C; cursor:pointer;" onclick="location.href='${ pageContext.servletContext.contextPath }/views/user/main/shareInfo.jsp'"></i>
                    ...
                    <p style="font-size: 20px; text-align: center; padding-bottom: 10px; margin-top: 20px;">
                        ...
                        <div style="text-align: center; margin-top: 30px;"><button class="btn_submit" onclick="location.href='${ pageContext.servletContext.contextPath }/views/user/main/shareInfoWrite.jsp'">확인</button></div>
                    </div>
                </div>
