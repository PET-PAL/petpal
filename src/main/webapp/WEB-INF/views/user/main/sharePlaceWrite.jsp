	...
	<body data-spy="scroll" data-target=".navbar-collapse">
    	...
    	<section id="menutable" class="menutable">
	    	<form method="post" action="${pageContext.servletContext.contextPath}/user/insert/write/sharePlace" enctype="multipart/form-data">
				<div style="width: 70%; border: 1px solid rgba(175, 175, 175, 0.616); margin: 0px auto; border-radius: 20px; margin-bottom: 30px;">
					<table class="table" style="border-collapse: separate;">
						...
						<tr>
							...
							<td><input type="text" name="placeName" placeholder="장소명을 입력하세요" style="border: none; width: 80%"></td>
						</tr>
						<tr>
							<td style="text-align: center; background-color: #F1FAF8; width:25%;"><p><strong>장소 주소</strong></p></td>
							<td>
								<input type="text" id="address" name="placeAddress" placeholder="장소 주소를 검색해주세요" readonly style="border: none; width: 80%">
						...
						<tr>
							...
							<td><input type="text" name="placePhone" placeholder="장소 연락처를 입력하세요" style="border: none; width: 80%"></td>
						</tr>
					</table>
			    ...
			    <div style="margin: 0px auto; text-align: center; margin-bottom: 50px;"><button type="button" class="reviewWrite" onclick="location.href='#completeReport'">게시글 작성</button></div>
